...
export const OFFICIAL_URL = 'https://lobe.1yo.cc';
export const OFFICIAL_PREVIEW_URL = 'https://lobe.1yo.cc';
export const OFFICIAL_SITE = 'https://spark.noxox.cn';
...
export const DOCKER_IMAGE = 'https://hub.docker.com/r/nebuluxe/lobe';
...
export const DISCORD = 'https://discord.gg/xCGYM9BGM7';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat-plugins.lobehub.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL = 'https://spark.noxox.cn';

export const AGENTS_INDEX_GITHUB = 'https://spark.noxox.cn';
...
export const EMAIL_SUPPORT = 'nebuluxe@1yo.cc';
export const EMAIL_BUSINESS = 'nebuluxe@1yo.cc';

export const MEDIDUM = 'https://chat.1yo.cc';
export const X = 'https://chat.1yo.cc';
